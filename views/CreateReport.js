...
const ENGLISH_TIME_FORMAT = { hour: '2-digit', minute: '2-digit', hour12: false };
...
class CreateReport extends Component {
    ...
    async sendReport() {
        ...
        this.state.reportEntries.map(obj => {
            let obt = new Date(obj.time).toLocaleTimeString('en-CA', ENGLISH_TIME_FORMAT)
    ...
    render() {
        let stTime = new Date(this.state.startTime).toLocaleTimeString('en-CA', ENGLISH_TIME_FORMAT)
        // console.log('StartTime is : ',stTime )

        let etTime = new Date(this.state.endTime).toLocaleTimeString('en-CA', ENGLISH_TIME_FORMAT)
        // console.log('EndTime is : ',etTime)

        let adTime = new Date(this.state.entryTime).toLocaleTimeString('en-CA', ENGLISH_TIME_FORMAT)
        ...
        return (
            <View style={{ flex: 1 }}>
                ...
                <LinearGradient style={{
                    width: screenWidth, height: screenHeight * 1.1,
                        ...
                        <View>
                            ...
                            </View>
                            {
                                this.state.reportEntries.map((obj, index) => {
                                    ...
                                    let objTime = new Date(obj.time).toLocaleTimeString('en-CA', ENGLISH_TIME_FORMAT)
                                ...
                                <ScrollView>
                                    {
                                        this.state.siteArray.length > 0 ? this.state.siteArray.map((site, index) => (
                                            <TouchableOpacity onPress={() => {
                                                ...
                                                width: screenWidth * 0.65, height: 48, backgroundColor: '#fff', marginVertical: 8, justifyContent: 'center',
